...
- ⚠ **第14話の申し送り（2026-08-19・ドライスーツ3部作の①）**: 「冬の海はいちばん青い／ドライで海の季節は終わらない」。**売らない回**（料金・購入・メンテ・水没・ドライSPは出していない。②③の担当）。
  ...
  ドライの期間は**当店の運用（10月中旬〜6月中旬・年により6月いっぱい）**。水温は気象庁 相模湾平年値（12/15 18.5℃・2/20 15.3℃・6/15 21.7℃）。
  流氷（知床・クリオネ）・シルフラは「ドライが着られると行ける海が増える」の例示まで（**当店ツアーではない**・旅行業登録なし）。
  🔴 **サイトに冬・ドライシーズンの記載がほぼ無い**（レンタル¥1,100とドライSP¥27,500のみ）。**fun-diving か FAQ にドライの季節（10月中旬〜6月中旬）と冬の透明度の1行を足す**と、第9・13・14話の事実がすべてサイトで裏取りできる。
